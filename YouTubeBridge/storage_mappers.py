...
def row_to_session(row: sqlite3.Row | None) -> dict | None:
    ...
    return {
        ...
        "post_plan_free_talk_idle_turns_min": int(row_value(row, "post_plan_free_talk_idle_turns_min", 6) or 6),
        "post_plan_free_talk_idle_turns_max": int(row_value(row, "post_plan_free_talk_idle_turns_max", 6) or 6),
        "post_plan_free_talk_audience_turns_min": int(row_value(row, "post_plan_free_talk_audience_turns_min", 3) or 3),
        "post_plan_free_talk_audience_turns_max": int(row_value(row, "post_plan_free_talk_audience_turns_max", 3) or 3),
        "post_plan_free_talk_topic_pack_ids": json_load(row_value(row, "post_plan_free_talk_topic_pack_ids_json", "[]"), []),
        "free_talk_closing_target_batches": int(row_value(row, "free_talk_closing_target_batches", 10) or 10),
        "free_talk_closing_min_batch_size": int(row_value(row, "free_talk_closing_min_batch_size", 5) or 5),
        "free_talk_closing_max_batch_size": int(row_value(row, "free_talk_closing_max_batch_size", 30) or 30),
        "free_talk_closing_time_limit_seconds": int(row_value(row, "free_talk_closing_time_limit_seconds", 300) or 300),

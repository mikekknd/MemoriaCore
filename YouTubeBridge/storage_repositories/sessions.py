    ...
    def upsert_session(self, config: dict) -> dict:
        ...
        with self._lock, self._connect() as conn:
            ...
            row_data = {
                ...
                "host_interaction_rules": str(config.get("host_interaction_rules", "") or "")[:4000],
                "program_segment_plan": str(config.get("program_segment_plan", "") or "")[:4000],
                "program_segment_turns": max(1, min(int(config.get("program_segment_turns", 3) or 3), 12)),

...
export const state = {
  ...
  topicPacks: [],
  topicEntries: [],
  topicGraph: { nodes: [], edges: [] },
  topicGraphTraces: [],
  topicGraphLatestTrace: null,
  selectedTopicGraphNodeId: 0,
  topicGraphBusy: false,
  ...
  eventsAutoRefreshInFlight: false,
  eventActionOverlayTimer: null,
...
export function installTestIds() {
  [
    ...
    "injectInterval", "injectMinIntervalSeconds", "plannedDuration", "scInterruptCooldown", "directorAudienceInterruptCooldown", "directorMaxAudienceBatchesPerPlannedTurn", "sessionTopicPackSelect", "autoInject", "autoFinalize",
    ...
    "testSuperChatCountPerTick", "autoTestEvents", "generateTestEvents", "saveTestEventSettings", "eventsList",
    "eventActionOverlay", "eventActionTitle", "eventActionMessage",
    "presentationEnabled", "ttsEnabled", "presentationAckTimeout",
    "directorGuidance", "hostInteractionRules", "programSegmentPlan", "programSegmentRows", "addProgramSegmentRow", "programSegmentTurns", "directorIdle", "directorDialogueExpansionEnabled", "topicPackSelect",
    ...
    "openTopicGraphModal", "topicGraphModal", "topicGraphModalSvg", "topicGraphModalDetails", "closeTopicGraphModal",
    ...
    "liveTtsSourcePreset", "liveTtsEnabled", "liveTtsRefAudioPath", "liveTtsPromptText", "liveTtsTextLang",
    "liveTtsPromptLang", "liveTtsSpeedFactor", "liveTtsMediaType",

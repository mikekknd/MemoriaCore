...
本階段的 provider-neutral contract 已由 `YouTubeBridgeV2/presentation/tts.py` 提供。真實 TTS provider、browser ack callback、storage 寫入與 API route wiring 仍由後續 integration layer 負責。

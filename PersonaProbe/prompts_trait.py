...
TRAIT_V1_SYSTEM: str = (
    ...
    "若片段包含「上下文（...，非分析對象）」行，那是其他 AI 的發言，只能用來理解前後文，\n"
    "不可引用為 trait 證據，也不可把其語氣或行為歸因給目標 AI。\n"
    "\n"
    "規則：\n"
...
TRAIT_REPORT_SYSTEM: str = (
    ...
    "\n"
    "⚠️ 分析主體：報告描述的是 AI 角色的人格傾向，不是使用者或其他 AI 的行為模式。\n"
    "若對話片段包含「上下文（...，非分析對象）」行，只能拿來補足因果脈絡，不可當作人格證據引用。\n"
    "\n"
    "報告結構（固定）：\n"
